...
# docker build -t organizational_chart .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name organizational_chart organizational_chart
